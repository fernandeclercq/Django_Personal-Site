...
DEBUG = bool(environ['IS_DEBUGGING'] in ['True'])
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'), # Add templates dir
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'posts.context_processor.context_processor',
            ],
        },
    },
]
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    "toolbar2": "pagebreak | charmap emoticons | "
